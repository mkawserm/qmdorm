 ...
 * \param parent
 */
QDjangoModel::QDjangoModel(QDjango *qdjango):
    m_qdjango(qdjango)
{
}
...
{
    const QDjangoMetaModel metaModel = this->m_qdjango->metaModel(metaObject()->className());
...
bool QDjangoModel::hasContext() const
{
    if(m_qdjango==0) return false;
    else return true;
}

QDjango *QDjangoModel::getContext()
{
    return this->m_qdjango;
}
